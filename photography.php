...
<body class="is-preload">
	...
	<div id="wrapper">
		...
		<header id="header">
			<h1><a href="<?php $this->permalink() ?>"><strong><?php $this->title() ?></strong> Powered by NailinShirley</a></h1>
			<nav>
				<ul>
			...
			<div class="inner split">
				<div>
					...
					<p class="copyright">
						...
						&copy; <?php echo date("Y")?> <a href="<?php $this->options->siteUrl(); ?>"><?php $this->options->title() ?></a> Powered by <a href="https://blog.nailinshirley.com/about.html">NailinShirley</a>
					</p>
				</div>
				<div>
					<section>
