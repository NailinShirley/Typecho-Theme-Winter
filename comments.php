  ...
  <form method="post" action="<?php $this->commentUrl() ?>" id="comment-form" onsubmit="return false">
    <?php if ($this->user->hasLogin()): ?>
      ...
      <div class="vwrap">
        ...
        <div class="vedit">
          <textarea name="text" id="veditor" class="veditor vinput" placeholder="这是一个评论区"><?php $this->remember('text', false); ?></textarea>
        </div>
        <div class="vcontrol">
    ...
    <?php else: ?>
      <div class="vwrap">
        ...
        <div class="vedit">
          <textarea name="text" id="veditor" class="veditor vinput" placeholder="想要说些什么?"><?php $this->remember('text'); ?></textarea>
        </div>
        <div class="vcontrol">
          <div class="col col-20" title="Markdown is supported">
            <a href="https://segmentfault.com/markdown" target="_blank">
